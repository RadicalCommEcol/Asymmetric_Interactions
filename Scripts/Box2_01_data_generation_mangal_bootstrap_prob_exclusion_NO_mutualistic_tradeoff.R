...
# Boostrap of the probabilities of exclusion for the 88 networks in mangal,
...
for(network_i in networks_included){
    ...
    write_csv(mangal_prob_exclusion,
              paste0("Results/mangal_processed_data/NO_NAs_NO_mutualistic_tradeoff_mangal_boot_networks_rep_",
