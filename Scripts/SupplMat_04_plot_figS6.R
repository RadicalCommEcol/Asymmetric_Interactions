...
first_sp_excluded_results_symmetric <- read_csv("Results/simulations/first_sp_excluded_ODE_results_symmetric.csv")
...
prob_excl_AnisoFun_symmetric <- 
  read_csv("Results/simulations/prob_excl_AnisoFun_symmetric.csv") %>%
...
first_sp_excluded_results_block <- read_csv("Results/simulations/first_sp_excluded_results_block.csv")
...
prob_excl_AnisoFun_block <- 
  read_csv("Results/simulations/prob_excl_AnisoFun_block.csv") %>%
...
first_sp_excluded_results_upper <- read_csv("Results/simulations/first_sp_excluded_results_upper.csv")
...
prob_excl_AnisoFun_upper <- 
  read_csv("Results/simulations/prob_excl_AnisoFun_upper.csv") %>%
