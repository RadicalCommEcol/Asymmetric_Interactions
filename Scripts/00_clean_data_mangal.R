...
write_csv(matrix_nodes_processed, "Results/mangal_processed_data/mangal_pollination_quant_nodes.csv")
write_csv(matrix_links_processed, "Results/mangal_processed_data/mangal_pollination_quant_links.csv")
...
write_csv(matrix_nodes_processed_2, "Results/mangal_processed_data/mangal_pollination_quant_nodes_2.csv")
write_csv(matrix_links_processed_2, "Results/mangal_processed_data/mangal_pollination_quant_links_2.csv")
...
write_csv(matrix_links_processed_kingdom, 
          "Results/mangal_processed_data/NO_NAs_mangal_links_processed_kingdom.csv")

write_csv(resulting_matrix_links_processed_kingdom, 
          "Results/mangal_processed_data/ALL_mangal_links_processed_kingdom.csv")
