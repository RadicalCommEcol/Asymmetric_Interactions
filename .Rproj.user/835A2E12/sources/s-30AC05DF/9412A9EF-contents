...
data_results_3 <- read_csv(paste0("Data/results_shape_indices_comparisson_D",total_number_species,".csv"))
...
data_saavedra_3 <- read_csv(paste0("Data/results_saavedra_shape_indices_comparisson_D",total_number_species,".csv"))
...
data_results_6 <- read_csv(paste0("Data/results_shape_indices_comparisson_D",total_number_species,".csv"))
...
data_saavedra_6 <- read_csv(paste0("Data/results_saavedra_shape_indices_comparisson_D",total_number_species,".csv"))
...
data_results_10 <- read_csv(paste0("Data/results_shape_indices_comparisson_D",total_number_species,".csv")) %>%
...
data_saavedra_10 <- read_csv(paste0("Data/results_saavedra_shape_indices_comparisson_D",total_number_species,".csv"))
...
library(ggpubr)
png("Images/relative_cos_side_lengths_VS_relative_J_index_2.png",
