...
write_csv(random_feasible_growth_rates,"Data/simulations/random_feasible_growth_rates_symmetric.csv")
write_csv(as.data.frame(first_sp_excluded_results_symmetric),"Data/simulations/first_sp_excluded_ODE_results_symmetric.csv")
write_csv(prob_excl_AnisoFun_symmetric,"Data/simulations/prob_excl_AnisoFun_symmetric.csv")
################################################################################
################################################################################
...
write_csv(prob_excl_AnisoFun_asymmetric,"Data/simulations/prob_excl_AnisoFun_asymmetric.csv")
...
write_csv(random_feasible_growth_rates_asymm,"Data/simulations/random_feasible_growth_rates_asymmetric.csv")
write_csv(as.data.frame(first_sp_excluded_results_asymmetric),"Data/simulations/first_sp_excluded_ODE_results_asymmetric.csv")
...
write_csv(prob_excl_AnisoFun_block,"Data/simulations/prob_excl_AnisoFun_block.csv")
...
write_csv(random_feasible_growth_rates_block,"Data/simulations/random_feasible_growth_rates_block.csv")
write_csv(as.data.frame(first_sp_excluded_results_block),"Data/simulations/first_sp_excluded_results_block.csv")
...
write_csv(prob_excl_AnisoFun_upper,"Data/simulations/prob_excl_AnisoFun_upper.csv")
...
write_csv(random_feasible_growth_rates_upper,"Data/simulations/random_feasible_growth_rates_upper.csv")
write_csv(as.data.frame(first_sp_excluded_results_upper),"Data/simulations/first_sp_excluded_results_upper.csv")
